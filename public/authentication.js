...
const divs = {
  ...
  <p class="field">Username : <input class="field" name="userName" type="text" required/></p>
  <p class="field">Password : <input class="field" name="password" type="password" required/></p>
